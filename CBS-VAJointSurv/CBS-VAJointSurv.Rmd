...
<div class = "w-small">
We are interested relation between discretely observed longitudinal variables 
...
<p class = "fragment"> 
Allows for time-varying (non-proportional) effects.</p>
...
$$
\int v(\vec o;\hat{\vec\zeta})p_{i,\hat{\vec\zeta}}(\vec o\mid\vec y_i)d\vec o \approx
...
<p class = "fragment"> 
$q^{(i)}_{\hat{\vec\theta}_i(\hat{\vec\zeta})}(\vec o) \approx p_{i,\hat{\vec\zeta}}(\vec o\mid\vec y_i)$ 
...
<p class = "fragment">
Simulation study to check the bias of the VA and to compare 
...
areas in breast and breast cancer. 

<p class = "fragment">
Have 60081 women with 188037 longitudinal measurements.</p> 

<div class = "fragment w-small">
The women are cancer free at study entry and we look at the time to the first
breast cancer diagnosis.
<p class = "smallish">
BMI is included in both marker and survival sub-models. There is delayed entry 
due to the cancer free condition.</p></div>

## Application
<div class = "w-small">
Estimate a random intercept and a random slope model
<p class = "smallish">
...
<!-- Without slopes -->
<!--      & 0.1316 & 0.03045 & 3.777 & & 3.795 & & -587141.9 & 1.174 \\ -->
<!--      & (0.0128) & (0.01600) & (0.023) & & (0.023) & & & \\ -->
<!--    % (112001.04 + 26563.173) / 3600 -->
<!--    With slopes -->
<!--      & 0.1436 & 0.02663 & 3.675 & 0.002327 & 3.421 & 0.002281 & -586179.6 & 38.490 \\ -->
<!--      & (0.0133) & (0.01711) & (0.052) & (0.000161) & (0.052) & (0.000174) & & \\ -->

<!-- ```{r} -->
<!-- tbl_data <-  -->
<!--   rbind(c(0.1316, 0.03045, 3.777, )) -->
