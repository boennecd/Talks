...
<p class = "fragment">
Present work which I and Birzhan Akynkozhayev, a new PhD student of Mark 
...
$$
\begin{align*}
l_i(\vec\zeta) &= \log p_{i,\vec\zeta}(\vec y_i) 
...
distributed without the survival outcomes.
<p class = "smallish">
...
simples_sim_res <- lapply(head(seeds, 55), \(s){
