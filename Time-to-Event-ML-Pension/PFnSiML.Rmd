...
$\tilde T_i$ is time to event for individual $i$. 
...
<div class = "fragment">
 ...
 $$\part{\widetilde W}{j} = \tilde h(\part{x}{1}) / q(\part{x}{N})$$ 
...
Can use 
$(\part{\rR{\vec u}}{s}_{1:\bar t}, \part{\rR{w}}{s}_{1:\bar t})$ for 
$s = 1, \dots, N$.
...
p\Cond{\vec t_{k:\bar t}, \vec d_{k:\bar t}}{\vec u_k} \propto
  ...
  {\part{\lR{W}}{s}_k}{\gamma_k(\part{\lR{\vec u}}{s}_k)}
...
&\hspace{20pt}
  ...
  {\gamma_{k + 1}(\part{\lR{\vec u}}{j_s}_{k+1})
...
<p class = "fragment">
Can sample more particles in the smoothing step.</p>
