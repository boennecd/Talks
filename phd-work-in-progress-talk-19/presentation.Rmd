...
<p class="smallish">$Z$-scores are the parentheses except for the splines
...
`dynamichazard` implements the particle smoother suggested by @Fearnhead10.
...
@David13 find time-varying effect of log pledgeable assets.

@Filipe16 find time-varying log total assets coefficient in 
...
random intercept, and closed diamonds: same as before with random log relative 
...
effects, and marginal effect of log relative market value slope.</p>
