...
<p class = "smallish">
`r fix_ev$n_families * 16L` observations.</p>
</div>
...
<p class = "smallish">
"W/o extra" and "w/ extra" is with 5000 and 25000 samples per log 
...
<section class="center-horiz">
<h2>Fixed Families: Bias Estimates</h2>
<!--/html_preserve-->
...
# plot the errors
par(mar = c(4, 5, 1, 1))
boxplot(t(ev$errors[, "w/ extra" , ]), ylab = "Estimate - truth")
abline(h = 0, lty = 2)
```
