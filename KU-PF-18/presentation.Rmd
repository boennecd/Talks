...
\begin{align*}
y_{it} &\in\{0,1\} \\
h\LP{E\LPV{y_{it}}{\vect z_t, o_{it}}} &= \vect\beta^\top\vect z_{it} + o_{it}
\end{align*}
$$

<small>$h$ is a link function, $\vect x_{it}$ are know covariates, and $o_{it}$
...
$$
\begin{align*}
h\LP{E\LPV{y_{it}}{\vect z_t, o_{it}, \vect x_t, \vect u_{it}}} &= 
