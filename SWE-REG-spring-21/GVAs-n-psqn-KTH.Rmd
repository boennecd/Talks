...
$\text{dim}(\vec\theta) + \sum_{i = 1}^m \text{dim}(\vec\omega_i)$ instead 
of $\text{dim}(\vec\theta)$.
...
<p class="fragment">
BFGS does not preserve the sparsity of the Hessian $\tilde l$.</p>
...
<div class = "fragment w-small">
Compare with BFGS from R and L-BFGS
<p class = "smallish">
...
Three random effects per cluster, $m = 1000$ clusters, and $n_i = 10$ 
...
<p class = "smallish">
SEs are the standard errors. The GVA row uses the psqn package.</p>
</div>
